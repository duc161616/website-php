...
if(isset($_POST['submit'])) {
	...
	$query="INSERT INTO post_private (postTitle , postDesc , postTag , postAuthor)
...
<div class="container">
	...
	<div class="panel panel-default">
			    <div class="panel-heading">New Post Private</div>
			    <div class="panel-body">

			     <!-- FORM STARTS HERE --> 
			      <form role="form" method="POST" action="new_private_post.php">
